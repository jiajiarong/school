...
<div class="sbox">
	<h1 title=""></h1>
    <div class="cont">
		<h2 title="视频监控平台">视频监控平台</h2>
        <form method="post" id="loginForm" action="<%=request.getContextPath()%>/login/toIndex.login">
            <ul class="uls set">
           
            <li>
                <label class="required desc">登录名：</label>
                <input type="text" class="text medium" name="username" tabindex="1" />
            </li>
            <li>
                <label class="required desc">密   码：</label>
