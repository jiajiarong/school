...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp>当前位置：权限管理&nbsp;&raquo;&nbsp;<a href="<c:url value="/${system }/user/userlist.do"/>" title="用户管理">用户管理</a>&nbsp;&raquo;&nbsp;<span class="gray">添加用户</span>
    <a href="<c:url value="userlist.do"/>" title="返回用户管理" class="inb btn80x20">返回用户管理</a>
    </div>
	<form id="form111" name="form111" action="${path}/user/saveUser.do" method="post" enctype="multipart/form-data">
		<div class="edit set">
			<p>
			    <label><samp>*</samp>登录名：</label>
			    <input type="text" id="loginName" name="loginName" class="text state" reg2="^(.|\n){0,300}$" tip="任意字符，长度0-300"/>
				<span></span>
			</p>
			<p>
			    <label><samp>*</samp>密码：</label>
			    <input type="text" id="password" name="password" class="text state" reg2="^(.|\n){0,300}$" tip="任意字符，长度0-300"/>
				<span></span>
			</p>
			<p>
			    <label><samp>*</samp>用户名：</label>
			    <input type="text" id="userName" name="userName" class="text state" reg2="^(.|\n){0,300}$" tip="任意字符，长度0-300"/>
				<span></span>
			</p>
			<p>
			    <label><samp>*</samp>用户手机号：</label>
			    <input type="text" id="telephone" name="telephone" class="text state" reg2="^(.|\n){0,300}$" tip="任意字符，长度0-300"/>
				<span></span>
			</p>
			<p>
			    <label><samp>*</samp>用户地址：</label>
			    <input type="text" id="userAddress" name="userAddress" class="text state" reg2="^(.|\n){0,300}$" tip="任意字符，长度0-300"/>
				<span></span>
			</p>
			<p>
