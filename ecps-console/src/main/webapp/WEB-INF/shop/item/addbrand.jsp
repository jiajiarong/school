...
<script src="${path}/ecps/console/res/res/item/addBrand.js"></script>
...
<div class="frameR"><div class="content">
	...
	<form id="form111" name="form111" action="${path }/item/saveBrand.do" method="post" enctype="multipart/form-data">
	    <input type="hidden" id="lastFilePath" name="lastFilePath" />
		<div class="edit set">
			<p>
			...
			<p>
			    <label>排序：</label><input type="text" id="brandSort" reg1="^[1-9][0-9]{0,2}$" tip="排序只能输入1-3位数的正整数" name="brandSort" class="text small"/>
				<span class="pos">&nbsp;</span>
			</p>
			<p>
			    <label>&nbsp;</label>
			    <input type="submit" name="button1"  class="hand btn83x23" value="完成" /><input type="button" class="hand btn83x23b" id="reset1" value='取消' onclick="backList('${backurl}')"/>
			</p>
		</div>
	</form>
    <div class="loc">&nbsp;</div>
